<?php
    ...
    // $stmt->execute();
    // $admin = $stmt->fetch();
    // if (!empty($_POST['token_tg'])){
    //   $data = [
    //     'token_tg' => $_POST['token_tg'],
    //     'token_vk' => $_POST['token_vk']
    //   ];
    //   $sql = "UPDATE admins SET token_tg=:token_tg, token_vk=:token_vk";
...
<!-- <div class="info-block" id="requestsBlock">
  <div class="settings-div">
    <form action="", method="post">
      <input type="text" name="token_tg"placeholder="Токен телеграм бота" value="<?echo $admin['token_tg']?>">
      <input type="text" name="token_vk"placeholder="acces_token Вконтакте" value="<?echo $admin['token_vk']?>">
